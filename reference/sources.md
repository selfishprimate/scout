...
- **Verdict: not worth an automated slot** on this evidence, now measured twice. The inventory a candidate actually wants arrives through LinkedIn, the niche boards and Glassdoor first. If a candidate wants Indeed anyway, run it as a home-country-only pass with a real `l=`, the broadest discipline keyword, and expect dedup to absorb most of it.
